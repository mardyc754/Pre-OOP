...
//
// Prosze rozszerzyc definicje klas Grade oraz GradeBook (z poprzednich zajec)
// o funkcjonalnosc wykorzystana w ponizszej funkcji main().
...
// Definicja klasy Average moze byc umieszczona w Grade.h
//
...
int main() {
  ...
  GradeBook gradeBook("PPO-Lab-L1");
...
/**
[brachwal@vmate build]$ ./lab12 
[PPO-Lab-L1]: The GradeBook is empty
...
Current average: 3.2
Current average: 0
[PPO-Lab-L1]: Grade ID=1 value=2
[PPO-Lab-L1]: Grade ID=2 value=3
[PPO-Lab-L1]: Grade ID=3 value=4
[PPO-Lab-L1]: Grade ID=4 value=5
[PPO-Lab-L1]: Grade ID=5 value=2
*/